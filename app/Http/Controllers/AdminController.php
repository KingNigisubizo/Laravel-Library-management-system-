...
class AdminController extends Controller
{
    public function index()
    {
        ...
        if(Auth::id())
        {
...

            {
                ...
                return view('admin.index',compact('user','book','borrow'));
            }
  ...
  public function store_book(Request $request)
  {
    ...
    if($book_image)
    {
        ...
        $book_image_name= time().'.'.$book_image->
    ...
    if($auther_image)
    {
        ...
        $auther_image_name= time().'.'.$auther_image->
            getClientOriginalExtension();
...
public function update_book(Request $request,$id)
{
    ...
    return redirect('/show_book')->with('message','Category Updated Successfully');
}
