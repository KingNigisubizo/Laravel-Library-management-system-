...
<body>
 ...
 <div class="currently-market">
    ...
    <div class="col-md-8">
<input class="form-control" type="search" name="search" placeholder="Search for book title, Author name, category ......">
    </div>
    <div class="col-md-4">
              ...
              <div class="item">
                ...
                <div class="right-content">
                  ...
                  <div class="text-button">
                    <a class="btn btn-primary" href="{{url('book_details',$data->id)}}">View Book</a>
                  </div> 
                </br>
                  <div class="">
